...
/**
 * 1870. 准时到达的列车最小时速 | 难度：中等 | 标签：数组、二分查找
...
object Solution1870 {
    ...
    /**
     * 执行用时：568 ms, 在所有 Kotlin 提交中击败了 100.00% 的用户
     * 内存消耗：56.3 MB, 在所有 Kotlin 提交中击败了 100.00% 的用户
     * 通过测试用例：65 / 65
     */
