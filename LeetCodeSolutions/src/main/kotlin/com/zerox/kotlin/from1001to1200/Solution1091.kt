 ...
 * @author zhuxi
 * @since 2022/8/16 13:56
 */
object Solution1091 {
    /**
     * 执行用时：296 ms, 在所有 Kotlin 提交中击败了 90.00% 的用户
     * 内存消耗：50 MB, 在所有 Kotlin 提交中击败了 70.00% 的用户
     * 通过测试用例：89 / 89
     */
    ...
    private fun enqueueValidXY(
        grid: Array<IntArray>, visit: Array<BooleanArray>, x: Int, y: Int, n: Int,
        queue: java.util.LinkedList<Pair<Int, Int>>
    ): Boolean {
